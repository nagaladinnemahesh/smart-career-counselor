          ...
          <ul className="similar-jobs-ul-container">
            {similarJobsData.map(eachItem => (
              <SimilarJobs
                ...
                employmentType={employmentType} // Assuming employmentType from jobDataDetails is passed here
              />
            ))}
          </ul>
        </div>
...
class AllJobs extends Component {
  ...
  onGetProfileDetails = async () => {
    ...
    const profileApiUrl = 'https://apis.ccbp.in/profile' // Line 88 from image_4a2957.png, corrected from incomplete line
  ...
  renderJobDetailsView = () => {
    ...
    return (
      <div className="job-item-details-content">
        <div className="title-rating-location-container">
          <img
            src={companyLogoUrl}
            alt="job details company logo"
          ...
          <div className="title-rating-container">
            ...
            <div className="rating-container">
              <BsStarFill className="job-details-rating-icon" />
        ...
        <div className="location-type-package-container">
          <div className="location-type-container">
            ...
            <div className="job-details-job-type-container">
              <BsFillBriefcaseFill className="job-details-briefcase-icon" />
        ...
        <div className="description-visit-container">
          <h1 className="description-heading">Description</h1>
          <a href={companyWebsiteUrl} className="job-details-link-visit">
            Visit
          </a>
          <BiLinkExternal className="job-details-link-icon" />
        </div>
        <p className="description-text">{jobDescription}</p>
...
class ProfileDetails extends Component {
  ...
  renderFailureView = () => (
    <div className="profile-container">
      <button
        type="button"
        className="profile-details-retry-button"
...
These are all the components I HashChangeEvent